  ...
  <div class="card-body">
    ...
    <div class="row mb-3">
      ...
      <div class="row g-3">
        ...
        <div class="col-md-6">
          <label class="form-label">Garantia da assistencia tecnica</label>
...
<textarea id="obs-pragas" class="form-control" rows="3" placeholder="Digite observações gerais..."></textarea>
